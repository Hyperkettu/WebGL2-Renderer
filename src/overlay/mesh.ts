...
export class OverlayMesh {
    ...
    static COMPONENTS_PER_SPRITE_VERTEX = 21;
        ...
        for(let index = 0; index < sprites.length; index++) {
            ...
            for(let vertex = 0; vertex < OverlayMesh.VERTICES_PER_SPRITE; vertex++) {
               ...
               // OverlayMesh.VERTICES_PER_SPRITE * vertex;
                ...
                this.vao.vertexBuffer.floatArray[baseIndex + 4] = sprite.mask ? 1 : 0;

                this.vao.vertexBuffer.floatArray[baseIndex + 5] = sprite.tintColor[0];
                this.vao.vertexBuffer.floatArray[baseIndex + 6] = sprite.tintColor[1];
                this.vao.vertexBuffer.floatArray[baseIndex + 7] = sprite.tintColor[2];
                this.vao.vertexBuffer.floatArray[baseIndex + 8] = sprite.totalAlpha;

                this.vao.vertexBuffer.floatArray[baseIndex + 9] = sprite.worldTransform[0];
                this.vao.vertexBuffer.floatArray[baseIndex + 10] = sprite.worldTransform[1];
                this.vao.vertexBuffer.floatArray[baseIndex + 11] = sprite.worldTransform[2];
                this.vao.vertexBuffer.floatArray[baseIndex + 12] = 5

                this.vao.vertexBuffer.floatArray[baseIndex + 13] = sprite.worldTransform[3];
                this.vao.vertexBuffer.floatArray[baseIndex + 14] = sprite.worldTransform[4];
                this.vao.vertexBuffer.floatArray[baseIndex + 15] = sprite.worldTransform[5];
                this.vao.vertexBuffer.floatArray[baseIndex + 16] = 7.5

                this.vao.vertexBuffer.floatArray[baseIndex + 17] = sprite.worldTransform[6];
                this.vao.vertexBuffer.floatArray[baseIndex + 18] = sprite.worldTransform[7];
                this.vao.vertexBuffer.floatArray[baseIndex + 19] = sprite.worldTransform[8];
                this.vao.vertexBuffer.floatArray[baseIndex + 20] = 10
            }
        }
