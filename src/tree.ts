...
export class Tree {
    ...
    async create(renderer: Renderer) {
        this.trunk = new StaticMesh('tree-mesh');
    ...
    //    leaves.addMesh(leafMesh.getSubmesh('leafSubmesh'), Layer.OPAQUE);
     ...
     //   this.leaves = leafMesh;
       ...
       // staticMesh.createSubmesh(renderer.gl, 'leaves', leafMesh.getSubmesh('leafSubmesh').vertices, 
       // leafMesh.getSubmesh('leafSubmesh').indices, leafMesh.getSubmesh('leafSubmesh').materialID);
        
    //    mesh.toMeshDataFileMultiSubmesh(mesh1, 'oak-trees');
    }
